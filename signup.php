        ...
        <div class="w-full h-full flex items-center justify-center">
            ...
            <div class="w-3/5 h-full p-6 bg-[#eeeeee] rounded-2xl">
                ...
                <form action="Controller/UserController.php" method="POST" class="w-full">
                    <div id="form" class="hidden w-1/3 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-red-500 z-10 p-4">
                        <p class="text-xl font-bold text-center">VERIFY YOUR EMAIL ADDRESS</p>
                        <p class="text-sm text-center font-medium">A code has been sent to your email address</p>
                        <button name="continue" class="bg-[#ffc8a8] px-10 py-2 rounded-xl">Continue</button>
                    </div>
                    <div class="w-full flex gap-2 mb-5">
                        <div class="w-1/2 flex flex-col gap-1">
                            <label for="">First name</label>
                            <input type="text" name="first_name" class="w-full p-2 outline-none rounded-xl border focus:border-[#ffc8a8] shadow-md">
                        </div>
                        <div class="w-1/2 flex flex-col gap-1">
                            <label for="">Last name</label>
                            <input type="text" name="last_name" class="w-full p-2 outline-none rounded-xl border focus:border-[#ffc8a8] shadow-md">
                        </div>
                    </div>
                    <div class="w-full flex gap-2 mb-5">
                        <div class="w-1/2 flex flex-col gap-1">
                            <label for="">Email Address</label>
                            <input type="email" name="email" class="w-full p-2 outline-none rounded-xl border focus:border-[#ffc8a8] shadow-md">
                        </div>
                        <div class="w-1/2 flex flex-col gap-1">
                            <label for="">Contact Number</label>
                            <input type="text" name="contact" class="w-full p-2 outline-none rounded-xl border focus:border-[#ffc8a8] shadow-md">
                        </div>
                    </div>
                    <div class="w-full mb-5">
                        <label for="">Present Address</label>
                        <input type="text" name="address" class="w-full p-2 outline-none rounded-xl border focus:border-[#ffc8a8] shadow-md">
                    </div>
                    ...
                    <div class="w-full flex items-center">
                        <button name="signup" class="bg-[#ffc8a8] px-10 py-2 rounded-xl">Continue</button>
                    </div>
                </form>
            </div>
        </div>
